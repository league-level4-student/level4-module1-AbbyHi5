...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Eat to get bigger, and dont touch your tail or the walls! Go for a high score!";
	...
	private void setFoodLocation() {
		...
		// on the snake
		while(0==0) {
			randLocation = new Location(rand.nextInt(WIDTH), rand.nextInt(HEIGHT));
